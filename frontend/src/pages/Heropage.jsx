		...
		<>
			<div id="home" className="px-[8%]  w-100% h-[calc(100vh-10vh)] flex items-center justify-between">
				<div className="">
					...
					<a href="/Devesh(mern).pdf" download="Devesh(mern).pdf"><button type="button" className="px-5 py-2.5 flex justify-between gap-2 items-center border-none rounded-3xl mt-4  text-lg  bg-blue-800 hover:bg-blue-900"> <IoDownloadOutline style={{ backgroundColor: "rgb(30 64 175)", background: "transparent", fontSize: "22px" }} /> Download Resume</button></a>
				</div>
